...
class Stage0Test {
     ...
     * 기본 생성자만을 제공하고 관련 설정들은 setter를 통해 설정해줘야한다.
     *
     * DriverManagerDataSource는 위의 DriverManager를 Properties를 통해 등록할 수 있게 해주는 간단한 DataSource 구현체이다.
     * 여전히 ConnectionPool 기능을 제공하지 않는다.
     * ConnectionPool 기능 등을 사용하려면 HicariCPDataSource등을 사용한다.
     * OSGI와 같은 특수 환경에서는 SimpleDriverDataSource를 사용한다.
     *
     *
